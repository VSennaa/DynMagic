...
- [x] Seta sem recarga entre cargas: 3 tiros saem em ~0,45 s (só o lockout de 0,15 s). Definir intervalo mínimo entre cargas
- [x] HUD não mostra as cargas da Seta (grade de recarga fica sempre "pronta")
